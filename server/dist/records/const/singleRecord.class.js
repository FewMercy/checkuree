...
__decorate([
    ...
    __metadata("design:type", String)
], SingleRecord.prototype, "time", void 0);
__decorate([
    (0, class_validator_1.IsEnum)(day_type_enum_1.DayType, { message: '요일이 정확하지 않습니다.' }),
    (0, swagger_1.ApiProperty)({
        description: '출석요일',
        type: 'enum',
...
__decorate([
    (0, class_validator_1.IsEnum)(late_time_type_enum_1.LateTimeType, { message: '지각타입이 정확하지 않습니다.' }),
...
__decorate([
    (0, class_validator_1.IsEnum)(absence_type_enum_1.AbsenceType, { message: '결석타입이 정확하지 않습니다.' }),
    (0, class_validator_1.IsOptional)(),
