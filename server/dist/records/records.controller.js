...
__decorate([
    ...
    __param(1, (0, user_decorator_1.GetUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [createAll_record_dto_1.CreateAllRecordDto,
        user_entity_1.User]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, common_1.Get)('attendee/:attendeeId'),
    (0, swagger_1.ApiOperation)({
...
__decorate([
    (0, common_1.Get)('attendance/:attendanceId/summary'),
    (0, swagger_1.ApiOperation)({
...
__decorate([
    (0, common_1.Get)('attendance/:attendanceId/:date/summary'),
    (0, swagger_1.ApiOperation)({
...
__decorate([
    (0, common_1.Get)('attendance/:attendanceId'),
    (0, swagger_1.ApiOperation)({
...
__decorate([
    (0, common_1.Get)('attendance/:attendanceId/excel'),
    (0, swagger_1.ApiOperation)({
...
__decorate([
    (0, common_1.Get)('attendee/:attendeeId/excel'),
    (0, swagger_1.ApiOperation)({
