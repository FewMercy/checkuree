...
export declare class RecordsController {
    ...
    getRecordSummaryByAttendeeId(attendanceId: string, attendeeRecordSummaryDto: AttendeeRecordSummaryDto): Promise<any[]>;
    getRecordSummaryByAttendanceId(attendanceId: string, date: string): Promise<any>;
