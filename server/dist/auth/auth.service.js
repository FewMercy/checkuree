...
let AuthService = class AuthService {
    ...
    generateAccessToken(payload) {
        return this.jwtService.sign(payload, {
            secret: auth_const_1.jwtConstants.accessTokenSecret,
            expiresIn: auth_const_1.jwtConstants.accessTokenExpiresIn,
        });
    }
    generateRefreshToken(payload, isAutoLogin) {
        return this.jwtService.sign(payload, {
            secret: auth_const_1.jwtConstants.refreshTokenSecret,
            expiresIn: isAutoLogin ? auth_const_1.jwtConstants.autoLoginRefreshTokenExpiresIn : auth_const_1.jwtConstants.refreshTokenExpiresIn,
        });
    }
    ...
    verifyRefreshToken(oldRefreshToken) {
        try {
            return this.jwtService.verify(oldRefreshToken, { secret: auth_const_1.jwtConstants.refreshTokenSecret });
        }
        catch (err) {
