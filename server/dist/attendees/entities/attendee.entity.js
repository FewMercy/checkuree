...
const grade_enum_1 = require("../const/grade.enum");
const gender_enum_1 = require("../const/gender.enum");
...
__decorate([
    (0, typeorm_1.Column)({ comment: '출석 대상자 성별', type: 'varchar' }),
    (0, swagger_1.ApiProperty)({ description: '출석 대상자 성별', type: 'enum', enum: gender_enum_1.Gender }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.Column)({ comment: '출석 대상자 생년월일', type: 'varchar', nullable: true }),
    (0, swagger_1.ApiProperty)({ description: '출석 대상자 생년월일', type: 'string' }),
    __metadata("design:type", String)
], Attendee.prototype, "birth", void 0);
__decorate([
    (0, typeorm_1.Column)({ comment: '출석 대상자 과정', type: 'varchar', nullable: true }),
    (0, swagger_1.ApiProperty)({ description: '출석 대상자 과정', type: 'string' }),
    __metadata("design:type", String)
], Attendee.prototype, "course", void 0);
__decorate([
    (0, typeorm_1.Column)({ comment: '출석 대상자 학교', type: 'varchar', nullable: true }),
    (0, swagger_1.ApiProperty)({ description: '출석 대상자 학교', type: 'string' }),
    __metadata("design:type", String)
], Attendee.prototype, "school", void 0);
__decorate([
    (0, typeorm_1.Column)({ comment: '출석 대상자 학년', type: 'varchar', nullable: true }),
    (0, swagger_1.ApiProperty)({ description: '출석 대상자 학년', type: 'enum', enum: grade_enum_1.AttendeeGrade, example: grade_enum_1.AttendeeGrade.초등3학년 }),
    __metadata("design:type", String)
], Attendee.prototype, "grade", void 0);
__decorate([
